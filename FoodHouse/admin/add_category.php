...
if(isset($_POST['submit'] ))
{
	...
	$check_cat= mysqli_query($db, "SELECT c_name FROM item_category where c_name = '".$_POST['c_name']."' ");
	...
	$mql = "INSERT INTO item_category(c_name) VALUES('".$_POST['c_name']."')";
	mysqli_query($db, $mql);
                            ...
                            <div class="table-responsive m-t-40">
                                <table id="myTable" class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
												$sql="SELECT * FROM item_category order by c_id ASC";
