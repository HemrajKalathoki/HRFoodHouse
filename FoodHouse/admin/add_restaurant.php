                ...
                <body class="fix-header">
                    ...
                    <div id="main-wrapper">
                        ...
                        <div class="page-wrapper">
                            ...
                            <marquee onMouseOver="this.stop()" onMouseOut="this.start()">Kalathoki team is the owner of this project and we are very sesative about the user satisfction.</marquee>
                            </div>
